import { c as create_ssr_component, b as spread, e as escape_object, d as add_attribute, f as compute_rest_props, v as validate_component } from "../../chunks/ssr.js";
...
const ChubLogo = "/v2/_app/immutable/assets/wLogo_white.QuBn1yDu.png";
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<footer class="w-full"><div class="mb-10 opacity-0" data-svelte-h="svelte-orosdt">Footer</div> <div id="footer-layer" class=""><div class="justify-center mx-20 max-lg:mx-5">   <div class="max-md:pb-[50px] pb-[50px] border-b-[1px] border-solid border-b-white"><div class="mt-20 max-md:mt-10 flex justify-between"><div class="w-full">  <img class="bg-transparent w-[9rem] md:w-[14rem] ml-[-10px]"${add_attribute("src", ChubLogo, 0)} alt="CHUB logo">  <p class="text-[0.4rem] lg:text-[12px]" data-svelte-h="svelte-7be61p">Ready, Set, Grow.</p></div>  <div class="flex items-center justify-end gap-10 w-full max-md:flex-row max-md:gap-[15px]"><a href="https://linkedin.com/thechubapp">${validate_component(FontAwesomeIcon, "FontAwesomeIcon").$$render($$result, { icon: faLinkedin, size: "2x" }, {}, {})}</a> <a href="https://twitter.com/@thechubapp">${validate_component(FontAwesomeIcon, "FontAwesomeIcon").$$render($$result, { icon: faTwitter, size: "2x" }, {}, {})}</a> <a href="https://tiktok.com/@thechubapp">${validate_component(FontAwesomeIcon, "FontAwesomeIcon").$$render($$result, { icon: faTiktok, size: "2x" }, {}, {})}</a> <a href="https://instagram.com/@thechubapp">${validate_component(FontAwesomeIcon, "FontAwesomeIcon").$$render($$result, { icon: faInstagram, size: "2x" }, {}, {})}</a></div></div> </div>  <div class="mt-10 max-md:mt-5 pb-10 flex max-md:flex-col justify-between" data-svelte-h="svelte-qrx6kh"><div class="text-[12px] w-full"><p>© 2024 CHUB. All rights reserved.</p></div> <div class="flex gap-1 justify-end max-md:justify-start text-[12px] w-full"><p><a href="/cookies">Cookies |</a> <a href="/policies">Policies |</a> <a href="/terms-and-condition">Terms &amp; conditions |</a> <a href="/privacy-policy">Privacy Policy</a></p></div></div></div></div></footer>`;
});
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `   <div class="relative flex flex-col max-w-full mx-auto w-full text-sm sm:text-base"><div${add_attribute(
    "class",
