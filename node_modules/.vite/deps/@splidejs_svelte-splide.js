...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$new_props) => {
    ...
    if ("splide" in $$new_props)
      $$invalidate(4, splide = $$new_props.splide);
    if ("extensions" in $$new_props)
      $$invalidate(6, extensions = $$new_props.extensions);
    if ("transition" in $$new_props)
      $$invalidate(7, transition = $$new_props.transition);
    if ("hasTrack" in $$new_props)
      $$invalidate(1, hasTrack = $$new_props.hasTrack);
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("transition" in $$props)
      $$invalidate(7, transition = $$new_props.transition);
    if ("hasTrack" in $$props)
      $$invalidate(1, hasTrack = $$new_props.hasTrack);
    if ("root" in $$props)
      $$invalidate(2, root = $$new_props.root);
    if ("prevSlides" in $$props)
      prevSlides = $$new_props.prevSlides;
    if ("prevOptions" in $$props)
      $$invalidate(10, prevOptions = $$new_props.prevOptions);
  };
